...
def recurrence_rationale(
    ...
    # A PI-RADS sentence stood here between S3 and S4, when the ordering carried a
    # PI-RADS term. The term is withdrawn (stratified.PIRADS_WITHDRAWN_AFTER) and
    # the sentence goes with it: describing a step that no longer runs is exactly
    # the reveal dishonesty this module exists to avoid.
